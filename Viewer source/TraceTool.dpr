...
uses
  ...
  JsonViewerFormU in 'JsonViewerFormU.pas' {JsonViewerForm},
  JSONViewerFrameU in 'JSONViewerFrameU.pas' {JSONViewerFrame: TFrame},
  unt_Utils in 'unt_Utils.pas',
  HexEditorFormU in 'HexEditorFormU.pas' {HexEditorForm},
  FullViewFormU in 'FullViewFormU.pas' {FullViewForm},
  Vcl.Themes,
  Vcl.Styles,
  TEDataModU in 'TEDataModU.pas' {TEDataMod: TDataModule},
  unt_Format in 'unt_Format.pas',
...
begin
  ...
  FastMM_MessageBoxEvents := [];
   ...
   Application.CreateForm(TTEDataMod, TEDataMod);
