...
type
  ...
  TFrm_Tool = class(TForm)
    ...
    ImageCollection1: TSVGIconImageCollection;
    vilActions16: TSVGIconVirtualImageList;
    vilActions24: TSVGIconVirtualImageList;
    ImageList1: TImageList;
    vilActions20: TSVGIconVirtualImageList;
    icStatus: TSVGIconImageCollection;
    vilStatus16: TSVGIconVirtualImageList;
    icStatusW: TSVGIconImageCollection;
    vilStatusW: TSVGIconVirtualImageList;
  ...
  private
    ...
    procedure RefreshIcons(ImageList: TSVGIconVirtualImageList; Color: TColor);
...
begin
   ...
   // MOD_IL
   //pmuTaskBar.Images := vilActions24;
   MainMenu.Images   := vilActions20;
   Actions.Images    := vilActions24;
...
begin
   ...
   if XMLConfig.AppDisplay.DarkTheme.Attributes             ['Value'] = Null then XMLConfig.AppDisplay.DarkTheme.Value := False;
...
begin
   ...
   TraceConfig.AppDisplay_DarkTheme                     := XMLConfig.AppDisplay.DarkTheme.Value;
...
begin
   ...
   try
      ...
      XMLConfig.AppDisplay.DarkTheme.Value                    := TraceConfig.AppDisplay_DarkTheme;
...
procedure TFrm_Tool.RefreshCollection(Collection: TSVGIconImageCollection;
  Color: TColor);
var
  I: Integer;
begin
  for I := 0 to Collection.SVGIconItems.Count - 1 do
    Collection.SVGIconItems[I].FixedColor := Color;
end;

procedure TFrm_Tool.RefreshIcons(ImageList: TSVGIconVirtualImageList;
  Color: TColor);
begin
  //ImageList.ImageCollection := ImageCollection2;
  ImageList.AutoFill := False;
  ImageList.Clear;
  ImageList.AutoFill := True;
end;
//------------------------------------------------------------------------------
