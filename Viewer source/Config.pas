...
{ IXMLAppDisplay }
  ...
  IXMLAppDisplay = interface(IXMLNode)
    ...
    function Get_DarkTheme: IXMLBooleanTagValue;
    ...
    property DarkTheme: IXMLBooleanTagValue read Get_DarkTheme;
...
begin
  ...
  RegisterChildNode('DarkTheme', TXMLBooleanTagValue);
...
function TXMLAppDisplay.Get_DarkTheme: IXMLBooleanTagValue;
begin
  Result := ChildNodes['DarkTheme'] as IXMLBooleanTagValue;
end;
